	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'pico':
				...
				flipX = true;
				//you don't understand how long it took me to get the offsets right - lexicord
			case 'cheeky':
				tex = Paths.getSparrowAtlas('mugenstuff/cheeky_assets');
				frames = tex;
				...
				flipX = false;
			case 'crazycheeky':
				tex = Paths.getSparrowAtlas('mugenstuff/cheekyhouse/AngryCheeky');
				frames = tex;
				animation.addByPrefix('idle', 'Cheeky Idle Dance', 24);
				animation.addByPrefix('singUP', 'Cheeky NOTE UP', 24);
				animation.addByPrefix('singRIGHT', 'Cheeky NOTE RIGHT', 24);
				...
				flipX = false;
			case 'housecheeky':
				tex = Paths.getSparrowAtlas('mugenstuff/CustomCharSprites/red_cheeky');
				frames = tex;
				animation.addByPrefix('idle', 'Cheeky Idle Dance', 24);
				animation.addByPrefix('singUP', 'Cheeky NOTE UP', 24);
				animation.addByPrefix('singRIGHT', 'Cheeky NOTE RIGHT', 24);
				...
				flipX = false;
			case 'cheekygun':
				tex = Paths.getSparrowAtlas('mugenstuff/cheekymad_assets');
				frames = tex;
				animation.addByPrefix('idle', 'Cheeky Idle Dance', 24);
				animation.addByPrefix('singUP', 'Cheeky NOTE UP', 24);
				animation.addByPrefix('singRIGHT', 'Cheeky NOTE RIGHT', 24);
			...
			case 'bf':
				...
				flipX = true;
			case 'bf-housecool':
				var tex = Paths.getSparrowAtlas('mugenstuff/CustomCharSprites/purple_BF');
				frames = tex;
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
				animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
				...
				flipX = true;
			case 'bf-house':
				var tex = Paths.getSparrowAtlas('mugenstuff/CustomCharSprites/BF_House');
				frames = tex;
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
				animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
				...
				flipX = true;
			case 'bf-death':
				var tex = Paths.getSparrowAtlas('mugenstuff/CustomCharSprites/gundeath');
				frames = tex;
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
				animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
